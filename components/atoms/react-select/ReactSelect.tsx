...
const ReactSelect: FC<IReactSelect> = ({
  ...
  return (
    <div className={clsx(props.containerClassName, props.labelClassName, 'text-sm leading-5 font-normal')}>
      {props.label && <label className={'text-sm text-neutral-700 ' + props.labelClassName ?? ''}>{props.label}</label>}
