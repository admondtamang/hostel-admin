    ...
    <div
      ...
      className={clsx(
        ...
        !(props.type === 'radio' || props.type === 'checkbox') &&
          'border border-normal-input rounded-md h-[42px] focus:border-back focus-within:border-black',
        disabled && 'bg-[#EDEDED]',
        error && 'border-error',
        props.className,
      )}
    >
      <div className={clsx('flex flex-row gap-2 px-3 py-4 w-full items-center')}>
        ...
        <input
          ...
          className={clsx(
            props.className,
            'outline-none ease-in w-full focus:outline-0 border-0 p-0 focus:border-0 focus:border-white focus:shadow-none focus:ring-0 focus:ring-none',
            status && error ? 'border-error' : 'border-normal-input placeholder-neutral-500 placeholder:font-medium',
            disabled && 'bg-[#EDEDED]',
